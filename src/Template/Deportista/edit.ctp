<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $deportistum->iddeportista],
                ['confirm' => __('Are you sure you want to delete # {0}?', $deportistum->iddeportista)]
            )
        ?></li>
...
<div class="deportista form large-9 medium-8 columns content">
    <?= $this->Form->create($deportistum) ?>
    <fieldset>
        <legend><?= __('Edit Deportistum') ?></legend>
        <?php
